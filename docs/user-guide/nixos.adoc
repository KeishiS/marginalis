...
現行archiveは``marginalis-archive-17``で、AdocWeave package版``0.41.0``とnote profile版``5``を記録します。
...
現行版の``restore-archive``へ渡します。現行版は直前契約として受理し、
``marginalis-archive-17`` / 0.41.0 / 5へ変換して復元します。
