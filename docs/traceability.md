...
| REQ-OPS-005 | 旧schema拒否試験 | 更新前退避 |
| REQ-DATA-001 | domain・SQLite単体試験 | アーカイブ照合 |
...
| REQ-AUTH-007 | session・保守処理単体試験、NixOS VM | 期限確認 |
...
| REQ-UI-004 | React編集・UTF-8位置単体試験、ブラウザー試験 | 診断からの修正 |
| REQ-UI-005 | React描画fixture・MathJax失敗試験、ブラウザー試験 | 閲覧・プレビュー |
...
| REQ-FORMAT-001 | schema・archive拒否試験 | 更新前退避 |
