...
`v0.30.1`を2026-08-05に公開しました。公開済み機能と移行方法は
[変更履歴](../CHANGELOG.md#0301--2026-08-05)、確認結果は
[v0.30.1受入結果](acceptance-results/v0.30.1.md)を参照してください。この文書には公開履歴を
...
[#307](https://github.com/KeishiS/marginalis/issues/307)で分割し、ノートの作成経路と人手確認状態を扱う
[#232](https://github.com/KeishiS/marginalis/issues/232)を実装しました。

残る作業は、受入用の候補コミットを固定し、schema 18からのexport、archive 15への移行、schema 19への
隔離復元とimportを実環境で確認することです。作成経路、人手確認状態、文書書庫の変更検出が受入基準を
満たした後に`v0.31.0`として公開します。
