...
xref:../CHANGELOG.adoc#top[変更履歴]も確認してください。
...
xref:adocweave-v0.36-migration.adoc#top[0.36移行判断]を参照してください。
...
header後の属性操作など、 xref:adocweave-v0.17-migration.adoc#top[0.17移行判断]に記載した差を
