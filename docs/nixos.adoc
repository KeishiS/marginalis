...
v0.15.0が作成したarchive 8は、復元前に現行のarchive 17へ変換します。SQLite schema 20には引用の索引、MCP OAuthの状態表、scope上限、
...
xref:adocweave-v0.33-migration.adoc#top[0.33移行判断]を参照してください。
