...
mod tests {
    use super::*;
    use crate::{ServerNoteUseCases, ServerOidcAuthenticationUseCases, ServerWebSessionUseCases};
    use marginalis_application::{
        AuthenticationUseCaseError, NoteUseCaseError, NoteUseCases, OidcAuthenticationUseCases,
        SessionLifetime, WebSessionUseCases,
    };
    use marginalis_auth_oidc::OidcConfiguration;
    use marginalis_domain::{AuthenticatedSession, NoteDraft, WebSession};
