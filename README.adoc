...
NixOSの設定、秘密情報、バックアップについては xref:docs/nixos.adoc#top[NixOSでの運用]、
MCPへの接続方法については xref:docs/mcp.adoc#top[MCPへの接続と認可]を参照してください。
...
設計上の規則は xref:docs/requirements.adoc#top[要件定義]と xref:docs/architecture.adoc#top[アーキテクチャ]、
今後の作業計画は xref:docs/roadmap.adoc#top[ロードマップ]を参照してください。
