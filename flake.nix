{
  ...
  outputs =
    ...
    let
      ...
      # AdocWeave v0.23.0 が要求する Rust 1.97.1 を確定的にピンする。
      rustToolchainFor =
        pkgs:
        ...
        in
        {
          ...
          default = rustPlatform.buildRustPackage {
            ...
            cargoLock = {
              lockFile = ./Cargo.lock;
              outputHashes = {
                "adocweave-0.23.0" = "sha256-KXZm2JPfbcuD42+SXyYo63D2VpEm20GB7fgrVkElr6A=";
              };
            };
            cargoBuildFlags = [
              "--package"
        ...
        pkgs.lib.optionalAttrs pkgs.stdenv.isLinux {
          ...
          nixos-module-runtime-vm = pkgs.testers.nixosTest {
            ...
            testScript = ''
              machine.wait_for_unit("marginalis.service")
              machine.succeed(
                "test \"$(/run/current-system/sw/bin/marginalis --version)\" = 'marginalis 0.20.0'"
              )
