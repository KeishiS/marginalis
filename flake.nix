{
  ...
  inputs.adocweave = {
    url = "github:KeishiS/adocweave/27cc6447041d19ae395119063bed35b1fad2d179";
    inputs.nixpkgs.follows = "nixpkgs";
        ...
        let
          ...
          frontend = pkgs.stdenvNoCC.mkDerivation (finalAttrs: {
            ...
            pnpmDeps = pkgs.fetchPnpmDeps {
              ...
              inherit pnpm;
              fetcherVersion = 4;
              hash = "sha256-TJxVkqD8tiYfl+vrP3rUDtTrcLuqJZPT5baDD4VtfRc=";
            };
            nativeBuildInputs = [
              pkgs.nodejs_22
              pkgs.pnpmConfigHook
        ...
        in
        {
          ...
          default = rustPlatform.buildRustPackage {
            ...
            cargoLock = {
              lockFile = ./Cargo.lock;
              outputHashes = {
                "adocweave-${adocweaveVersion}" = "sha256-6xvnxvTk+fywULhxkZt7tjbDQc7i0ccfZrNF6NnxHHA=";
