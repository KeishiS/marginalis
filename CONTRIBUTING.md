...
この文書は、人がMarginalisの開発へ参加するための入口です。開発環境、検証、GitHubでの
作業手順の正本は[GitHubを使う開発手順](docs/development.md)です。製品仕様や運用手順は
[文書案内](docs/README.md)から参照してください。

## 作業の始め方

1. 作業前に関連するGitHub Issueと現行仕様を確認します。
2. 最新の`main`から目的が分かる作業ブランチを作成します。
3. 既存の形式と責務境界に従い、変更に対応する文書と試験も更新します。
...
Pull Request、ログ、試験成果物へ記録しません。脆弱性や認証情報の漏えいが疑われる場合は、
